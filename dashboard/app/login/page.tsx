...
export default function LoginPage() {
  ...
  // Initialize theme mode from localStorage or system preferences
  useEffect(() => {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'admin@remotepay.com' && password === 'admin123') {
        ...
        setErrorMessage('Invalid credentials. Please use the default demo account.')
        setIsLoading(false)
      }
    }, 600)
  }
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex items-center justify-center p-4 relative overflow-hidden font-sans transition-colors duration-300">
